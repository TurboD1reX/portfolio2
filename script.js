...
<div class="alert alert-danger d-flex position-fixed align-items-center col-sm-12 col-md-3" role="alert">
...
// Чтобы скрыть дополнительную информацию, вы можете добавить кнопку "Закрыть"
